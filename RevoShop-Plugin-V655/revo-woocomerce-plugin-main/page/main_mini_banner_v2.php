...
<body>
                ...
                <tbody>
                  ...
                  foreach ($data_banner as $key => $value) : ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-primary" data-toggle="modal" onclick="clickedEditModal(event); updatebutton(this.value);" data-target="#Banner<?php echo $value->id ?>" value="<?php echo $update ?>">
                                        ...
                                        <select name="type" class="form-control" style="max-width: unset;font-size: 12px;color: #777777;margin-right: 0px;">
                                          <?php for ($i = 0; $i < count($type_banner); $i++) { ?>
                                            <?php if (isset($type_banner[$i]['exist'])) : ?>
                                              <option value="<?php echo $type_banner[$i]['text'] ?>" <?= $type_banner[$i]['text'] == $value->type ? 'selected' : '' ?> <?= isset($type_banner[$i]['exist']) ? 'disabled' : '' ?>><?php echo $type_banner[$i]['text'] ?></option>
                                            <?php else : ?>
                                        ...
                                        <div class="d-flex">
                                          <div>
                                            ...
                                            <div class="radio-custom radio-primary mr-2">
                                              ...
                                              <label class="font-size-14" for="directToCat<?= $value->id ?>">Category</label>
                                            </div>
                                            <div class="radio-custom radio-primary mr-2">
                                          ...
                                          <div class="pl-4">
                                            <div class="radio-custom radio-primary mr-2">
                                              ...
                                              <label class="font-size-14" for="directToAttribute<?= $value->id ?>">Attribute</label>
                                            </div>
                                            <div class="radio-custom radio-primary mr-2">
                                              ...
                                              <label class="font-size-14" for="directToUrl<?= $value->id ?>">URL</label>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select name="type" class="form-control" style="max-width: unset;font-size: 12px;color: #777777;margin-right: 0px;">
                    <?php for ($i = 0; $i < count($type_banner); $i++) { ?>
                      <?php if (isset($type_banner[$i]['exist'])) : ?>
                        <option value="<?php echo $type_banner[$i]['text'] ?>" <?= isset($type_banner[$i]['exist']) ? 'disabled' : '' ?>><?php echo $type_banner[$i]['text'] ?></option>
                      <?php else : ?>
  ...
  <script type="text/javascript">
    ...
    function fieldupdate(element, param, param2) {
      ...
      if (param == 'Product') {
        const select2Parent = $('#Banner' + param2).find('#states');
        const banner_data = <?= json_encode($data_banner) ?>;
        const specificData = banner_data.find(x => x.id === param2);

        $('#Banner' + param2).find('#states').html('');
        getProductDatas(select2Parent);

        let data = {
          id: specificData.product_id,
          text: specificData.product_name
        };
