                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="updateSlider<?php echo $value->id ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <span class="required" aria-required="true">*</span> -->
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" name="set_url_link" class="form-control" id="updateLinkTo<?php echo $value->id ?>" placeholder="eg.: google.co.id/slider.jpeg" value="<?php echo $xplode[$indexIP] ?>">
